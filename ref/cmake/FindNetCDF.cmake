...
foreach( _comp IN LISTS _search_components )
  ...
  message("NetCDF_${_comp}_INCLUDE_FILE: ${NetCDF_${_comp}_INCLUDE_FILE}")
...
foreach( _comp IN LISTS _search_components )
  ...
  find_program( NetCDF_${_comp}_CONFIG_EXECUTABLE
      ...
      message("NetCDF_${_comp}_CONFIG_EXECUTABLE: ${NetCDF_${_comp}_CONFIG_EXECUTABLE}")
endforeach()
...
foreach( _comp IN LISTS _search_components )
  ...
  message("NetCDF_${_comp}_LIBRARY: ${NetCDF_${_comp}_LIBRARY}")
