...
LOGICAL FUNCTION AssertTrue(cond1, cond2) 
IMPLICIT NONE

	logical, intent(in) :: cond1, cond2

AssertTrue = cond1 .EQV. cond2

END FUNCTION AssertTrue

LOGICAL FUNCTION AssertFalse(cond1, cond2) 
IMPLICIT NONE

        logical, intent(in) :: cond1, cond2

AssertFalse = cond1 .EQV. cond2
